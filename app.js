...
pizzaIndex=foods.indexOf("pizza")
foods.splice(pizzaIndex,0,"tofu")
...
*/
let  yummy=[]
yummy=foods.slice(foods.indexOf("sushi"),foods.indexOf("sushi")+2)
console.log(foods.indexOf("sushi"))
console.log(foods.indexOf("sushi")+2)
...
*/
let total=0
numArrays.forEach ((eachNum1) => {
    eachNum1.forEach ((eachNum2) => {
